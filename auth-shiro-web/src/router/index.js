...
export const asyncRoutes = [
  {
    ...
    children: [
      ...
      {
        path: 'user',
        component: () => import('@/views/system-settings/user/index'),
        meta: {title: '用户管理'}
      },
      {
        path: 'role',
        component: () => import('@/views/system-settings/role/index'),
        meta: {title: '角色管理'}
      },
      {
        path: 'resource',
        component: () => import('@/views/system-settings/resource/index'),
        meta: {title: '资源管理'}
      },
      {
        path: 'allocResource',
